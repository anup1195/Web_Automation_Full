package com.fab_alley.verification;
...
public class FA_Login_Verificationpage {
...
//			Assert.assertEquals(Actualmsg, Expectedmsg);
			String Invalidloginmsg=driver.findElement(By.xpath("//span[contains(text(),'Invalid Email ID!')]")).getText();
		...
		public void FA_TCLP003(WebDriver driver) throws InvalidFormatException{
			...
			String Actualmsg=driver.getCurrentUrl();
//			//String Actualmsg=driver.findElement(By.id("emailError")).getText();
			String Invalidloginmsg=driver.findElement(By.xpath("//span[@id='spnpwderror']")).getText();
			String Expectedmsg=ExcelUtils.readData("Login", 3, 5);
			Assert.assertEquals(Invalidloginmsg, Expectedmsg);
		...
		public void FA_TCLP006(WebDriver driver) throws InvalidFormatException{
			...
			Reporter.log("Home page url is verified",true);
			String Actualmsg=driver.getCurrentUrl();
			String errormsg=driver.findElement(By.xpath("//span[contains(text(),'Invalid Email ID!')]")).getText();
			//System.out.println(Actualmsg);
			String Expectedmsg=ExcelUtils.readData("Login", 6, 5);
