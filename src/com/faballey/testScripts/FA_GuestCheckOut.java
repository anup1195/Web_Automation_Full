...
//			=====================coupon end======================================================
			...
			driver.findElement(By.xpath("//a[contains(text(),'Guest Checkout')]")).click();
			
			driver.findElement(By.id("txtGuestEmail")).sendKeys("Guest@faballey.com");
			
			driver.findElement(By.id("add-phone")).sendKeys("1100000000");
			
			driver.findElement(By.id("FirstName")).sendKeys("Test");
			
			driver.findElement(By.id("add-pincode")).sendKeys("201301");
			
			driver.findElement(By.id("addaddress")).sendKeys("test c11");
